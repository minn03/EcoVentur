...
public class TutorialsAdapter extends RecyclerView.Adapter<TutorialsAdapter.ArticlesViewHolder> {

    private final List<Tutorials> itemList;
    private Context context;

    public TutorialsAdapter(Context mContext, List<Tutorials> itemList) {
